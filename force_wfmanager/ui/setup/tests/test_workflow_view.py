...
class TestWorkflowView(WfManagerBaseTestCase, UnittestTools):
    ...
    def test_init_workflow_view(self):
        variable_names_registry = self.workflow_view.variable_names_registry
        ...
        self.assertEqual(
            process_view,
            variable_names_registry.process_view
        )
        ...
        self.assertEqual(
            kpi_view.kpi_name_options[0].name,
            kpi_view.model_views[0].selected_variable.name
        )
